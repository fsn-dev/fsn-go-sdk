...
import (
	...
	"github.com/FusionFoundation/fsn-go-sdk/efsn/internal/jsre"
	"github.com/FusionFoundation/fsn-go-sdk/efsn/internal/rpc"
	"github.com/FusionFoundation/fsn-go-sdk/efsn/internal/web3ext"
...
type Config struct {
	...
	Prompter tools.UserPrompter // Input prompter to allow interactive user feedback (defaults to TerminalPrompter)
...
type Console struct {
	...
	prompter tools.UserPrompter // Input prompter to allow interactive user feedback
